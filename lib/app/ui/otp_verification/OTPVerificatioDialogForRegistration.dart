...
import 'OTPVerificationDialogForPassword.dart';

Widget otpVerificationDialogForRegistration(String email) {
  OTPVerificationController otpController =
      Get.find<OTPVerificationController>();
  otpController.email = email;
  otpController.isOtpRequired.value = false;
  return Builder(
    builder: (context) {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Flexible(
              flex: 5,
              child: Text(
                "Please enter the code to complete your registeration.",
                textAlign: TextAlign.center,
              ),
            ),
            Spacer(flex: 2),
              ...
              children: [
                ...
                TextButton(
                  ...
                  onPressed: () {
                    ...
                    otpController.submitOTPCode(otpCode);
                  },
                  child:
